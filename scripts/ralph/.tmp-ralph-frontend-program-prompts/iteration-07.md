...
Recent progress notes:
 updates in `React.startTransition` in v7. You can use the `v7_startTransition` future flag to opt-in early. For more information, see https://reactrouter.com/v6/upgrading/future#v7_starttransition.
...
Story to implement:
ID: FEP-07
Title: Core Module Shell Structure Sweep
Description:
Harden shared module shell tabs, side navigation consistency, and panel composition across modules.
...
acceptanceCriteria:
- Top tabs and left navigation remain coherent across modules.
- Sidebar supports dense navigation without visual breakage.
- Shell layout remains stable under content pressure.
