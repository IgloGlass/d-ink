...
es in `React.startTransition` in v7. You can use the `v7_startTransition` future flag to opt-in early. For more information, see https://reactrouter.com/v6/upgrading/future#v7_starttransition.
...
## 2026-03-05T17:02:12.051Z
Story passed: FEP-04 - Company Selector Search-First Sweep
...
Story to implement:
ID: FEP-05
Title: Group Control Panel Premium Sweep
Description:
Elevate group control panel layout, profile/summary/directory rhythm, and status signaling consistency.
...
acceptanceCriteria:
- Profile, summary, and directory sections are visually separated and coherent.
- Status badges use consistent tone logic.
- Quick-open actions remain stable.
