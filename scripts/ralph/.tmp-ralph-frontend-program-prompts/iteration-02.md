...
Future Flag Warning: Relative route resolution within Splat routes is changing in v7. You can use the `v7_relativeSplatPath` future flag to opt-in early. For more information, see https://reactrouter.com/v6/upgrading/future#v7_relativesplatpath.
...
Story to implement:
ID: FEP-02
Title: App Shell and Header Premium Sweep
Description:
Refine the global app shell/header, context badge, language control, and launcher interactions so top-level navigation feels enterprise-premium and consistent.
...
acceptanceCriteria:
- Header remains fixed at 56px with clean hierarchy.
- Launcher interaction supports fast keyboard flow and clear focus treatment.
- Shell controls follow V4 spacing and border rules.
