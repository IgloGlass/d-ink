...
import policyPackJson from "./policy-pack.tax-adjustments-depreciation-differences-basic.v1.json";

const PolicySchema = z
  .object({
    schemaVersion: z.literal("ai_policy_pack_v1"),
    moduleId: z.literal("tax-adjustments-depreciation-differences-basic"),
    ...
    timeouts: z
      ...
      .strict(),
    targetField: z.literal("INK2S.depreciation_adjustment"),
    direction: z.literal("informational"),
  })
  .strict();

export function loadTaxAdjustmentsDepreciationDifferencesBasicModuleConfigV1() {
