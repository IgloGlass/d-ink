...
import policyPackJson from "./policy-pack.tax-adjustments-non-deductible-expenses.v1.json";

const PolicySchema = z
  .object({
    schemaVersion: z.literal("ai_policy_pack_v1"),
    moduleId: z.literal("tax-adjustments-non-deductible-expenses"),
    ...
    timeouts: z
      ...
      .strict(),
    targetField: z.literal("INK2S.non_deductible_expenses"),
    direction: z.literal("increase_taxable_income"),
  })
  .strict();

export function loadTaxAdjustmentsNonDeductibleExpensesModuleConfigV1() {
